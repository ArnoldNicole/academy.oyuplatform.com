...
@section('content')
    ...
    <footer id="footer">
        ...
        <div class="container footer-bottom clearfix text-center">
            {!! $settings['footer_text'] ?? '<p>&copy; {{ date("Y") }} <strong><span><a href="https://https://qtechafrica.com/" target="_blank"
                rel="noopener noreferrer">QTECHAFRICA</a></span></strong>. All Rights Reserved</p>' !!}
