                            ...
                            <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        {{ Form::number('due_charges', null, ['class' => 'form-control', 'value'=>0, 'placeholder' => __('due_charges'), 'required', 'min' => 0]) }}
                                    </div>
                            ...
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list'
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="class.full_name" data-visible="true">{{__('Class')}}</th>
