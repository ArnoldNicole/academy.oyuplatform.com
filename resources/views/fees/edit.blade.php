                        ...
                        <form class="common-validation" action="{{ route('fees.update',$fees->id) }}" method="POST" novalidate="novalidate">
                            ...
                            <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                                        <label>{{ __('due_charges')}}  <span class="text-info small">( {{__('in_percentage')}} )</span></label>
                                        {{ Form::number('due_charges', $fees->due_charges, ['class' => 'form-control', 'placeholder' => __('due_charges'), 'min' => 0, 'value'=>0]) }}
                                    </div>
                                </div>
                            </div>
                            <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                            ...
                            <input type="hidden" name="include_fee_installments" class="fees-installment-toggle user-select-none" value="0">
                            @if(false)
                            <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                                <div class="col-12 mt-1">
                                    <h4 class="card-title">
                                    ...
                                    <div data-repeater-list="fees_installments">
                                        <div data-repeater-item class="col-12 row">
                                            ...
                                            <div class="form-group col-lg-12 col-xl-3">
                                                <label>{{ __('due_charges') }}<span class="text-info small">( {{__('in_percentage')}} )</span></label>
                                                {!! Form::text("due_charges",null, ["class" => "installment-due-charges form-control" , "placeholder" => trans('due_charges') , "required" => true , "data-convert" => "number", "min"=>0, 'value'=>0]) !!}
                                            </div>
