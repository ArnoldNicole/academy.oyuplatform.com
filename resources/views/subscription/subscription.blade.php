...
<div class="content-wrapper">
    ...
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <label class="feature-list text-center">
                                ...
                                @if ($addon->status)
                                <i class="fa fa-times text-danger discontinue_addon" data-id="{{ $addon->id }}" title="{{ __('discontinue_upcoming_plan') }}"></i>
                                @endif
        ...
        <div class="col-md-3 col-sm-12 col-tb-6 grid-margin stretch-card">
            <div class="card">
                @if ($upcoming_package && array_key_exists('auto_renewal_plan', $school_settings) && $school_settings['auto_renewal_plan'])
                <div class="card-body">
                    ...
                    <div class="upcoming-feature-list">
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12">
                                <label for="">{{ __('name') }}</label>
                                <input type="text" name="name" class="form-control form-control-sm" value="{{ $upcoming_package->name }}" readonly>
                            </div>
                        </div>
                ...
                <div class="mx-4 text-justify text-uppercase">
                    <small class="text-danger">{{ __('Note : Certain additional features will not be part of the next billing period as they have already been integrated into your upcoming subscription package') }}</small>
                </div>
                ...
                <div class="ml-auto">
                    <button class="btn btn-danger btn-sm text-wrap cancel-upcoming-plan" @if ($active_package->id == $upcoming_package->id) data-id="" @else data-id="{{ $upcoming_package->id }}" @endif
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table" data-url="{{ route('subscriptions.show', 1) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-fixed-columns="true" data-fixed-number="2" data-fixed-right-number="1" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-maintain-selected="true" data-export-data-type='all' data-query-params="subscriptionQueryParams" data-toolbar="#toolbar" data-export-options='{ "fileName": "subscription-list-<?= date('d-m-y') ?>"
